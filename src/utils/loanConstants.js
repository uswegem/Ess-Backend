...
const LOAN_CONSTANTS = {
  ...
  // ===== MANUAL MESSAGE TRIGGER: message types that require the elevated
  // 'messages:trigger_sensitive' permission (money movement / loan finality),
  // as opposed to the base 'messages:trigger' permission for routine resends =====
  SENSITIVE_MANUAL_TRIGGER_MESSAGE_TYPES: [
